...
public abstract class BaseEntity implements Serializable{
    private String id; // ID chính của Department là departmentID, của doctor là doctorID -> ID ở Base khi được kế thừa ở class nào sẽ được định nghĩa đúng với bản chất của class đó.
    private String name;
    ...
    public void setLastUpdateDate(Date ngayUpdate){this.lastUpdateDate = ngayUpdate;}
