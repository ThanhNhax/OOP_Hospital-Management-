...
public class Patient extends BaseEntity{
    ...
    public Patient(String PatID, String fullname, String sex, String addr, String phone, String dob, String diagnosis, String assignedDoctor, String status, Date creatDate, Date updateDate){
    ...
    public String toString(){
        ...
        return String.format("| %-15s | %-30s | %-7s | %-50s | %-10s | %-12s | %-20s | %-20s | %-15s | %-12s | %-12s |", getPatientID(), getPatientName(), sex, address, dob, phone, diagnosis, assignedDoctor, admissionStatus, sdfCreateDate, sdfUpdateDate);
    }
